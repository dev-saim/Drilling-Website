<?php
    ...
    if(isset($_POST['send']))
    {
        ...
        $request = "insert into form(name, email, phone, address, welldepth, handpump, concretebase, waterpump, solaroption, storagetank, watertanktower, cleanwatertank) values
                ('$name', '$email', '$phone', '$address', '$welldepth', '$handpump', '$concretebase', '$waterpump', '$solaroption', '$storagetank', '$watertanktower', '$cleanwatertank')";
    ...
    <section class="booking">
        ...
        <form action="services.php" method="post" class="book-form">
            ...
            <div class="flex">
                ...
                <div class="input-box">
                    <span for="well_depth">WELL DEPTH (up to 150 FT)</span>
                    <input type="number" placeholder="0" id="well_depth" name="well_depth" min="0" max="150" step="2" required>
                </div>

                <div class="input-box">
                    <span for="hand_pump">HAND PUMP (NALKA)</span>
                ...
                <div class="input-box">
                    <span for="water_pump">WATER PUMP</span>
                ...
                <div class="input-box">
                    <span for="water_tank_tower">WATER TANK TOWER (Custom-made Steel welded 4 Meters)</span>
